  ...
  if (quesRoomData.mcq === null) {
    ...
    for (let i = 0; i < shorterArrayLen; i++) {
      ...
      */
      ...
      const [optA, optB, optC, optD, optE] = entry.ansArr;
      ...
      MCQquesContent += `<div id="quesDiv" class="flex gap-4 font-semibold"> <div id="quesNumber" class="flex-none w-5">${quesNumber}.</div> <div id="quesHolder" class="grow text-justify">${quesContent}</div> </div> <div class="grid grid-cols-${ansCol}"> <div id="optDiv" class="flex gap-2 pl-10">  <span id="optNumber" class="flex-none w-3">a.</span> <div id="optHolder" class="grow text-justify">${optA}</div> </div> <div id="optDiv" class="flex gap-2 pl-10">  <span id="optNumber" class="flex-none w-3">b.</span> <div id="optHolder" class="grow text-justify">${optB}</div> </div> <div id="optDiv" class="flex gap-2 pl-10">  <span id="optNumber" class="flex-none w-3">c.</span> <div id="optHolder" class="grow text-justify">${optC}</div> </div> <div id="optDiv" class="flex gap-2 pl-10"> <span id="optNumber" class="flex-none w-3">d.</span> <div id="optHolder" class="grow text-justify">${optD}</div> </div> <div id="optDiv" class="flex gap-2 pl-10 ${optE == '' ? 'hidden':'block'}">  <span id="optNumber" class="flex-none w-3">e.</span> <div id="optHolder" class="grow text-justify">${optE}</div> </div> </div>`;
    }
